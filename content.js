(() => {
  ...
  const SETTINGS_KEYS = Object.keys(DEFAULTS);
	...
	const THEMES = ['glass', 'mono', 'sunset', 'vapor', 'contrast', 'deep-purple', 'dark-sepia', 'mocha', 'sakura', 'petal', 'glacier', 'orchid', 'amethyst', 'gamma', 'midnight', 'nocturne', 'nocturne-v2', 'velvet-noir', 'burrito'];
  const INTENSITIES = {
